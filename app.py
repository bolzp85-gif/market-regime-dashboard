...
# ==========================================
# 3. REAL MARKET DATA ENGINE (yFinance, FRED & CFTC)
# ==========================================
...
def fetch_sp500_cot_data():
    """Holt die echten wöchentlichen COT-Daten der Commercials direkt von der CFTC."""
        ...
        try:
            ...
            if res.status_code == 200:
                with zipfile.ZipFile(io.BytesIO(res.content)) as z:
                    ...
                    # Filter nach S&P 500 E-Mini / Consolidated
...
def fetch_real_market_data():
    """Holt echte Live- & Historien-Daten von Yahoo Finance, FRED und CFTC."""
    tickers = {
        "sp500": "^GSPC",
        "vix": "^VIX",
        "dxy": "DX-Y.NYB",
    ...
    # --- 5. COT-Daten (CFTC E-Mini S&P 500 Commercials) ---
    ...
    if cot_series is not None and not cot_series.empty:
        ...
        # Fallback falls CFTC-Server beschäftigt ist
...
# Daten laden
with st.spinner('Lade Live-Daten (yFinance, FRED & CFTC)...'):
...
st.caption(f"Stand: {df.index[-1].strftime('%d.%m.%Y')} | Asset: S&P 500 (Live-Daten inkl. CFTC COT)")
st.markdown("---")
