...
ASSET_CONFIGS = {
    ...
    "S&P 500": {
        ...
        # Fachlich begründete Startgewichtung
        #
        # Makroökonomie       25 %
        # Positionierung      15 %
        # Marktinterna        20 %
        # Technischer Trend   20 %
        # Fundamental         10 %
        # Frühwarnindikatoren 10 %
        #
        "Saeulen_Gewichte": {
            "Makroekonomie": 0.25,
            "Positionierung": 0.15,
    ...
    "Nasdaq 100": {
        ...
        # NQ-Future wird bewusst verwendet,
        # da er für Trading relevanter ist.
        "ticker": "NQ=F",
...
SUB_WEIGHTS_BASE = {
    ...
    # Real Yields und Net Liquidity etwas stärker gewichtet,
    # da sie für Risikoassets strukturell relevanter sind
    # als der absolute Fed Funds Rate allein.
    "Makroekonomie": {
    ...
    # Trendstruktur etwas stärker als kurzfristiges Momentum.
    "Technischer_Trend": {
...
LOOKBACK_CONFIG = {
    ...
    # Öl-Lagerbestände sind stark saisonal.
    # Deshalb etwas längerer Normalisierungszeitraum.
    "inventories": 756
}
...
def fetch_google_trends_sentiment(asset_name: str):
    ...
    try:
        ...
        clean_spread = net_spread.dropna()
        ...
        # Kontraindikator:
        #
        # hoher Bull/Bear-Spread
        # = mehr Euphorie
        # = niedriger Score
        #
        # niedriger Bull/Bear-Spread
        # = mehr Angst
        # = höherer Score
        #
...
def calculate_mci(scores, weights):
    ...
    # Theoretische maximale Standardabweichung
    # einer 0-100-Skala.
    max_std = 50.0
...
def fetch_multi_asset_data(
    ...
    if vol_data is not None:
        ...
        if isinstance(
            ...
            # Nach dem Yahoo-Download
            # kann die ursprüngliche
            # Ticker-Bezeichnung noch
            # vorhanden sein.

            if cfg["ticker"] in vol_data.columns:
            ...
            elif "asset" in vol_data.columns:
    ...
    #
    # Es ist ein Marktpreis-basierter Proxy.
    # Höherer LQD/HYG-Ratiowert = relativ stärkere
    # Investment-Grade-Anleihen gegenüber High Yield.
    #
    # Deshalb wird er im Modell als Stressindikator
    # behandelt und invertiert.
    #
    ...
    # --------------------------------------------------------
    #
    # Das ist KEINE echte Advance/Decline-Line.
    # Deshalb wird es korrekt als market_momentum
    # bezeichnet.
    #
    ...
    if selected_asset == "S&P 500":
        ...
        # Kein Live-KGV.
        # Deshalb bewusst als Modell-Proxy.
        #
        # Dieser Wert sollte später durch eine
        # echte historische KGV-Zeitreihe ersetzt werden,
        # wenn Fundamentalgewicht stärker genutzt werden soll.
    ...
    if cot_reindexed is not None:
        ...
        # Wird im UI als Fallback ausgewiesen.
        df_raw[
            "cot_commercials"
        ] = (
            -df_raw[
...
# ============================================================
# 29. INTRADAY EXECUTION CHECKLIST
# ============================================================
