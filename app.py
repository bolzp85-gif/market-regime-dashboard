...
SP500_CONFIG = {
    ...
    "Sub_Indikatoren_Gewichte": {
        "Makroekonomie": {
            ...
            "real_yields": 0.25,
            "usd_index": 0.25,
            "net_liquidity": 0.25  # NEU: Echte Dollar-Netto-Liquidität
        },
        "Positionierung": {
...
def fetch_fear_and_greed():
    """Holt den echten CNN Fear & Greed Index Score."""
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if hist:
                ...
                return df_hist.set_index("Date")["y"].sort_index()
...
def fetch_real_market_data():
    ...
    if FRED_API_KEY and FRED_API_KEY != "DEIN_FRED_API_KEY_HIER":
        try:
            ...
            # Bausteine für Fed Net Liquidity
            ...
            # Net Liquidity Berechnung in $ Milliarden
            ...
            df_raw["net_liquidity"] = net_liq.reindex(df_raw.index, method='ffill').ffill().bfill()
        except Exception:
